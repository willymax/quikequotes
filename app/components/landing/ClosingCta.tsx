...
export function ClosingCta({ signedIn }: { signedIn: boolean }) {
  return (
    <section className="relative bg-ink px-6 py-24 text-center overflow-hidden">
      <div
        aria-hidden
      ...
      <div className="relative max-w-lg mx-auto">
        <h2 className="text-3xl sm:text-4xl font-extrabold tracking-[-0.02em] mb-4 text-white">
